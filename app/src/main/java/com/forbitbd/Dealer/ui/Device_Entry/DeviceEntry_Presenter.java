...
public class DeviceEntry_Presenter implements DeviceEntry_Contract.Presenter{
    ...
    @Override
    public void device_entry(String _id,String etvehicle,String etreg_number, String etdevice_id,String etdevice_number, String etcustomer_number, String etcustomer_email,String etcustomer_name) {
